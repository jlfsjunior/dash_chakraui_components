...
class DashChakrauiComponents(Component):
    """A DashChakrauiComponents component.
...
- value (string; optional): The value displayed in the input."""
    ...
    def __init__(self, id=Component.UNDEFINED, label=Component.REQUIRED, value=Component.UNDEFINED, **kwargs):
        ...
        self._type = 'DashChakrauiComponents'
        ...
        super(DashChakrauiComponents, self).__init__(**args)
