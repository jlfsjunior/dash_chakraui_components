...
- isFocusable (boolean; default False): Is an interactive element or just for presentation"""
    @_explicitize_args
    def __init__(self, icon=Component.REQUIRED, viewBox=Component.UNDEFINED, boxSize=Component.UNDEFINED, color=Component.UNDEFINED, isFocusable=Component.UNDEFINED, **kwargs):
        self._prop_names = ['icon', 'viewBox', 'boxSize', 'color', 'isFocusable']
        self._type = 'Icon'
        self._namespace = 'dash_chakraui_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['icon', 'viewBox', 'boxSize', 'color', 'isFocusable']
