...
function __init__()
    ...
    external_url = "https://unpkg.com/dash_chakraui_components@0.0.4/dash_chakraui_components/dash_chakraui_components.min.js",
    dynamic = nothing,
    async = nothing,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/dash_chakraui_components@0.0.4/dash_chakraui_components/dash_chakraui_components.min.js.map",
    dynamic = true,
    async = nothing,
    type = :js
)
